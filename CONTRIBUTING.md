````markdown
# Contributing to CLI AQI App

We truly welcome contributions to the CLI AQI App! By contributing, you can help improve the project and make it more useful for everyone.
...
2. **Clone your forked repository**:
   ...
   ```bash
   git clone https://github.com/yashxsagar/cli-aqi-app.git
   cd cli-aqi
   ```
